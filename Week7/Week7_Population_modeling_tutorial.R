...
# We can quickly see these strains grow at different rates and have differing responses to antibiotics.
...
compLV(n01=10, n02=100,r1=0.05, r2=0.03, k1=80, k2=50, alfa=1.2, beta=0.5, tmax=600)
  # Notice the intial dip in species 1 numbers? This was a large enough population to temporarily out-compete species 1.
...
compLV(n01=10, n02=1000,r1=0.05, r2=0.03, k1=80, k2=50, alfa=1.2, beta=0.5, tmax=800)
  # Finally a number that swamps sp1 and causes their exterpation/extinction.
